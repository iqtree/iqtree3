...
// anymore.
void ModelPoMo::computeTransMatrix(double time, double *trans_matrix, int, int selected_row) {
  ...
  else ModelMarkov::computeTransMatrix(time, trans_matrix, -1, selected_row);
}
